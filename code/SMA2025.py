...
class Trading(Link):
	...
	def get_candles(self, data):
		...
		return self.fetch_candles(venue=self.VENUE, sym=self.SYMBOL, level=level, since=since)
	
	
	@http.route
	def get_balance(self, data):
		return self.fetch_balances(self.VENUE)['data']


	@http.route
	def get_position(self, data):
		return self.fetch_positions(self.VENUE)['data']
